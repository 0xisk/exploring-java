 ...
 */
public class InfoOfTennis extends JFrame {
    ...
    JLabel label13;
     ...
     public InfoOfTennis() throws IOException {
        ...
        label3.setText("Tennis players can also compete in open-water events (e.g., in a sea or lake)");
        ...
        this.add(label13);
         ...
         try {
            image = ImageIO.read(new File("C:\\Users\\Eskandr samir\\Desktop\\JS_Club\\Images\\Boula\\tennis.jpg"));
